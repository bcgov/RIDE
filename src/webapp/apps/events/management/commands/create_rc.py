...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        Event.objects.create(
            ...
            start=seg.primary_point.coords,
        ...
        Event.objects.create(
            ...
            approved=True,
            latest_approved=True,
            start=seg2.primary_point.coords,
        ...
        Event.objects.create(
            ...
            approved=True,
            latest_approved=True,
            start=seg3.primary_point.coords,
        ...
        Event.objects.create(
            ...
            approved=True,
            latest_approved=True,
            start=seg4.primary_point.coords,
        ...
        Event.objects.create(
            ...
            approved=True,
            latest_approved=True,
            start=seg5.primary_point.coords,
