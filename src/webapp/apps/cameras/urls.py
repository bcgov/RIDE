...
# router.register(r'camera-notes', CameraNoteViewSet)
router.register(
    r'cameras/(?P<camera_id>[^/.]+)/notes',
    CameraNoteViewSet,
    basename='camera-notes',
)
