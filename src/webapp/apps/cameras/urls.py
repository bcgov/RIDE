...
urlpatterns += [
    ...
    path(
            "camera-default-messaging/",
            CameraDefaultMessagingViewSet.as_view({
                "get": "list",
                "put": "update",
                "patch": "partial_update",
            }),
            name="camera-default-messaging",
        ),
        
    path(
                "cameras-order/",
                CamerasOrderViewSet.as_view({
                    "get": "list",
                    "put": "update",
                    "patch": "partial_update",
                }),
