  ...
  return (
    <div className="org-form">
      <div className={'container'}>
        ...
        <RIDETextInput label={'Authoritative contact:'} extraClasses={'mr-5 form'} value={contactName} handler={setContactName} maxLength={30} />
        <RIDETextInput label={'Contact IDIR/BCeID:'} extraClasses={'mr-5 form'} value={contactId} handler={setContactId} maxLength={30} />
      </div>
    </div>
  );
}
