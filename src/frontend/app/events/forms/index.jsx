...
import {
  CHANGE_TYPE_FORMS, CONDITIONS_FORMS, DELAYS_FORMS, DETAILS_FORMS,
  EXTERNAL_FORMS, IMPACTS_FORMS, INTERNAL_FORMS, RESTRICTIONS_FORMS,
  TIMING_FORMS,
} from '../references';
...
export class EventForm extends Component {
  ...
  render() {
    ...
    // when creating (but not when editing) incidents or planned events,
