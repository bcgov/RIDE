...
export const route2NormalStyle = new Style({
  stroke: new Stroke({
    color: [255, 51, 0, 0.5],
    width: 10,
  })
});
export const route2HoverStyle = new Style({
  stroke: new Stroke({
    color: [255, 51, 0, 0.75],
    width: 14,
  })
});
export const route2ActiveStyle = new Style({
  stroke: new Stroke({
    color: [255, 51, 0, 0.95],
    width: 12,
  })
...
export const route3NormalStyle = new Style({
  stroke: new Stroke({
    color: [0, 51, 0, 0.5],
    width: 6,
    lineDash: [6, 18],
...
export const route3HoverStyle = new Style({
  stroke: new Stroke({
    color: [0, 51, 0, 0.75],
    width: 8,
    lineDash: [6, 18],
...
export const route3ActiveStyle = new Style({
  stroke: new Stroke({
    color: [0, 51, 0, 0.95],
    width: 12,
    lineDash: [6, 12],
...
export default {
  pin: {
    ...
    route2: {
        normal: route2NormalStyle, active: route2ActiveStyle, hover: route2HoverStyle,
    },
    route3: {
        normal: route3NormalStyle, active: route3ActiveStyle, hover: route3HoverStyle,
    },
  },
};